    ...
    public class CharacterInstantiation : OnJoinedInstantiate {
        ...
        public new void OnJoinedRoom() {
            if (this.PrefabsToInstantiate != null) {
				GameObject o1 = PrefabsToInstantiate[(PhotonNetwork.player.ID - 1) % 4];
				...
				o1 = PhotonNetwork.Instantiate(o1.name, spawnPoints[PhotonNetwork.otherPlayers.Length].position, spawnPoint.rotation, 0);
                if (CharacterInstantiated != null) {
                    CharacterInstantiated(o1);
                }
            }
        }
    }
